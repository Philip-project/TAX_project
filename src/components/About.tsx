        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <div className="space-y-6 text-gray-700 leading-relaxed">
              <p className="text-lg">
                ProTax By KC and Associates is a trusted CPA firm offering expert tax filing, 
              ...
              <p className="font-semibold text-primary-900">
                At ProTax By KC and Associates, we go beyond compliance—we provide the strategic 
