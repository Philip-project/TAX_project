        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div>
            <h2 className="font-heading font-bold text-4xl text-primary-900 mb-6">
              About ProTax KC & Associates
            </h2>
            <div className="space-y-6 text-gray-700 leading-relaxed">
              <p className="text-lg">
                ProTax KC and Associates is a trusted CPA firm offering expert tax filing, 
              ...
              <p className="font-semibold text-primary-900">
                At ProTax KC and Associates, we go beyond compliance—we provide the strategic 
